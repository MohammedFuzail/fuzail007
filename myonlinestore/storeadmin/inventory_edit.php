...
if(isset($_POST['product_name'])){
	...
	$sql = mysql_query("UPDATE products SET product_name='$product_name',code='$code', price='$price', details='$details', category='$category', subcategory='$subcategory' WHERE id='$pid'");
...
if($product_count > 0)
{
	...
	$date_added = strftime("%b %d, %y",strtotime($row["date_added"]));
	$product_list .= "Product ID: $id - <strong>$product_name</strong> - <em>Added $date_added</em> &nbsp; &nbsp; &nbsp; <a href='inventory_edit.php?pid=$id'>edit</a> &bull; <a href='inventory_list.php?deleteid=$id'>delete</a><br />";
	//$product_list = "$id - $product_name - $date_added - &nbsp;&nbsp; <a href='inventory_edit.php?pid=$id'>edit</a> &bull; <a href='#'>delete</a> <br/>";
}
else
{
...
<table width="90%" border="0" cellspacing="0" cellpadding="6">
  ...
  <tr>
    ...
    <input type="submit" name="button" value="Add This item Now"/></label></td>
  </tr>
  <tr>
    <td width="20%">&nbsp;</td>
    <td width="80%">&nbsp;</td>
