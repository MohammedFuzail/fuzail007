...
<table width="100%" border="0" cellspacing="0" cellpadding="15">
  <tr>
   ...
   /* if(!loggedin())
	//{
		//echo 'Please Login first to add products in the cart!';
		//echo '<form id="form1" name="form1" method="post" action="users/userlogin.php">
	...
	{
		//header('loaction:/users/userlogin.php');
